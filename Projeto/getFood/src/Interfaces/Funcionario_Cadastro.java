...
public class Funcionario_Cadastro extends javax.swing.JFrame implements KeyListener {
    ...
    private void initComponents() {
        ...
        txtMatricula.setPreferredSize(new java.awt.Dimension(6, 34));
        ...
        txtNome.setPreferredSize(new java.awt.Dimension(6, 34));
        ...
        txtCargo.setPreferredSize(new java.awt.Dimension(6, 34));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/btn_Cadastrar.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Funcionario_Cadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Funcionario_Cadastro().setVisible(true);
            }
        });
    }
