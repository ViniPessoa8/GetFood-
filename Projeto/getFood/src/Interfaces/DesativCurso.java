...
public class DesativCurso extends javax.swing.JFrame {

    CursoDAO cur;
    Funcionario funLog;
    public DesativCurso(Funcionario fun) 
    {
        initComponents();
        cur = new CursoDAO();
         Vector v = null;
    ...
    private void initComponents() {
        ...
        btnDesativar.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnDesativar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesativCurso().setVisible(true);
            }
        });
    }
