...
public class AltSenhaLog extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtConfirma, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtNova, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtNova, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(txtConfirma, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46)
    ...
    private void btnAltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltActionPerformed
        ...
        String old = new String(txtSenha.getPassword());
        String nova = new String(txtNova.getPassword());
        String confirma = new String(txtConfirma.getPassword());
        boolean vld = log.validaLogin(txtLogin.getText());
        if(!vld)
        {
            JOptionPane.showMessageDialog(null,"O login não foi encontrado no banco de dados.");
            txtSenha.setText("");
            txtNova.setText("");
            txtConfirma.setText("");
        }else
        {
            ...
            {
                log.altSenha(txtLogin.getText(),nova);
                int k = JOptionPane.showConfirmDialog(null,"Alteração executada. Deseja alterar outra senha?");
                if(k == JOptionPane.YES_OPTION)
                {
                    dispose();
                    AltSenhaLog alt = new AltSenhaLog();
                    alt.setVisible(true);
                }else
                {
                    dispose();
            ...
            {
                JOptionPane.showMessageDialog(null,"A senhas digitadas não são compatíveis.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltSenhaLog().setVisible(true);
            }
        });
    }
